...
bool PioExtenderTest::execute_class_api_case(){
	...
	TEST_THIS_ASSERT(bool, configure_pin(i2c, 0x21, Pin::flag_set_output, (1<<15)), true);
	...
	TEST_THIS_ASSERT(bool, configure_pin(i2c, 0x20, Pin::flag_set_output, 0x0fff), true);
